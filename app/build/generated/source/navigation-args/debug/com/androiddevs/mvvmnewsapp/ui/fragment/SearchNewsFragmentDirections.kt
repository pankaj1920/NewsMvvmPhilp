...
public class SearchNewsFragmentDirections private constructor() {
  private data class ActionSearchNewsFragment2ToArticleFragment(
    public val article: Article
  ) : NavDirections {
    public override fun getActionId(): Int = R.id.action_searchNewsFragment2_to_articleFragment
  ...
  public companion object {
    public fun actionSearchNewsFragment2ToArticleFragment(article: Article): NavDirections =
        ActionSearchNewsFragment2ToArticleFragment(article)
  }
}
